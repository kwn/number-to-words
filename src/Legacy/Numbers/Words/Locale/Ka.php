...
class Ka extends Words
{
    ...
    private static $currencyNames = [
        ...
        'AMD' => [['დრამი'], ['ლუმა']],
        'PLN' => [['ზლოტი'], ['გროში']],
        'GBP' => [['ფუნტ სტერლინგი'], ['პენსი']],
        'AUD' => [['ავსტრალიური დოლარი'], ['ცენტი']],
        'ALL' => [['ლეკი'], ['კინდარკა']],
        'AED' => [['დირჰამი'], ['ფილსი']],
        'ARS' => [['არგენტინული პესო'], ['სენტავო']],
        'AWG' => [['ფლორინი'], ['ცენტი']],
        'AZN' => [['მანათი'], ['გეპიკი']],
        'NZD' => [['ახალზელანდიური დოლარი'], ['ცენტი']],
        'XPF' => [['ფრანკი'], ['სენტიმი']],
        'BYR' => [['ბელარუსული რუბლი'], ['კაპიკი']],
        'XOF' => [['აფრიკული ფრანკი'], ['სენტიმი']],
        'BMD' => [['ბერმუდული დოლარი'], ['ცენტი']],
        'BAM' => [['კონვერტირებადი მარკა'], ['ფენინგი']],
        'BRL' => [['ბრაზილიური რეალი'], ['სენტავო']],
        'BGN' => [['ბულგარული ლევი'], ['სტოტინკა']],
        'GTQ' => [['კეტცალი'], ['სენტავო']],
        'DKK' => [['კრონი'], ['ერე']],
        'TMT' => [['თურქმენული მანათი'], ['ტენნესი']],
        'ISK' => [['ისლანდიური კრონა'], ['ერე']],
        'IRR' => [['ირანული რიალი'], ['დინარი']],
        'ILS' => [['ახალი შეკელი'], ['აგორა']],
        'CAD' => [['კანადური დოლარი'], ['ცენტი']],
        'CZK' => [['ჩეხური კრონა'], ['ჰელერი']],
        'HRK' => [['ხორვატიული კუნა'], ['ლიპა']],
        'KZT' => [['ყაზახური ტენგე'], ['ტიინი']],
        'KRW' => [['სამხრეთ კორეული ვონი'], ['ჩონი']],
        'KWD' => [['ქუვეითური დინარი'], ['ფილსი']],
        'KGS' => [['ყირგიზული სომი'], ['ტიინი']],
        'LTL' => [['ლიტი'], ['ცენტი']],
        'NOK' => [['ნორვეგიული კრონი'], ['ერე']],
        'HKD' => [['ჰონკონგის დოლარი'], ['ცენტი']],
        'HUF' => [['ფორინტი'], ['ფილერი']],
        'PKR' => [['პაკისტანური რუპია'], ['პაისა']],
        'RUB' => [['რუსული რუბლი'], ['კაპიკი']],
        'RSD' => [['სერბული დინარი'], ['პარა']],
        'SGD' => [['სინგაპურის დოლარი'], ['ცენტი']],
        'SEK' => [['შვედური კრონა'], ['ერე']],
        'UAH' => [['გრივნა'], ['კაპიკი']],
        'UZS' => [['უზბეკური სომი'], ['ტიინი']],
        'CYP' => [['კვიპროსის გირვანქა'], ['ცენტი']],
        'EEK' => [['ესტონური კრონი'], ['სენტი']],
        'EGP' => [['ეგვიპტური გირვანქა'], ['პიასტრი']],
        'IDR' => [['ინდონეზიური რუფია'], ['სენი']],
        'LVL' => [['ლატვიური ლატი'], ['სანტიმი']],
        'MKD' => [['მაკედონური დენარი'], ['დენი']],
        'MRO' => [['მავრიტანული უგია'], ['ხუმი']],
        'MTL' => [['მალტური ლირა'], ['ცენტი']],
        'MYR' => [['მალაიზიური რინგიტი'], ['სენი']],
        'NGN' => [['ნიგერიული ნაირა'], ['კობო']],
        'PHP' => [['ფილიპინური პესო'], ['სენტავო']],
        'RON' => [['რუმინული ლეი'], ['ბანი']],
        'SAR' => [['საუდის არაბეთის რიალი'], ['ჰალალა']],
        'SIT' => [['სლოვენური ტოლარი'], ['სტოტინი']],
        'SKK' => [['სლოვაკური კრონი'], ['ჰელერი']],
        'XAF' => [['CFA ფრანკი'], ['სანტიმი']],
        'YUM' => [['იუგოსლავიური დინარი'], ['პარა']],
        'ZAR' => [['სამხრეთ აფრიკული რენდი'], ['ცენტი']],
    ];
