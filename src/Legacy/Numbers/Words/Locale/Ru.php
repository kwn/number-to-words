...
class Ru extends Words
{
    ...
    protected static $currencyNames = [
        ...
        'CNY' => [
            [1, 'китайский юань', 'китайского юаня', 'китайских юаней'],
            [1, 'фынь', 'фыня', 'фыней']
        ],
        'CYP' => [
        ...
        'IRR' => [
            [1, 'иранский риал', 'иранского риала', 'иранских риалов'],
        ...
        'KGS' => [
            [1, 'киргизский сом', 'киргизского сома', 'киргизских сомов'],
        ...
        'KWD' => [
            [1, 'кувейтский динар', 'кувейтского динара', 'кувейтских динаров'],
            [1, 'филс', 'филса', 'филсов']
        ],
        'LTL' => [
            [1, 'лит', 'лита', 'литов'],
        ...
        'MDL' => [
            [1, 'молдавский лей', 'молдавского лея', 'молдавских леев'],
            [1, 'бань', 'баня', 'баней']
        ],
        'MKD' => [
        ...
        'NZD' => [
            [1, 'новозеландский доллар', 'новозеландского доллара', 'новозеландских долларов'],
            [1, 'цент', 'цента', 'центов']
        ],
        'PLN' => [
        ...
        'SGD' => [
            [1, 'сингапурский доллар', 'сингапурского доллара', 'сингапурских долларов'],
            [1, 'цент', 'цента', 'центов']
        ],
        'SIT' => [
        ...
        'TRY' => [
            [2, 'турецкая лира', 'турецкой лиры', 'турецких лир'],
