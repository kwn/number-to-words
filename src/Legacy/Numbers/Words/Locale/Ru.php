...
class Ru extends Words
{
    ...
    protected static $currencyNames = [
        'AED' => [
            [1, 'дирхам ОАЭ', 'дирхама ОАЭ', 'дирхамов ОАЭ'],
            [1, 'филс', 'филса', 'филсов']
        ],
        'ALL' => [
            [1, 'лек', 'лека', 'леков'],
        ...
        'BAM' => [
            [2, 'конвертируемая марка', 'конвертируемых марки', 'конвертируемых марок'],
            [1, 'фенинг', 'фенинга', 'фенингов']
        ],
        'BGN' => [
            [1, 'лев', 'лева', 'левов'],
        ...
        'DZD' => [
            [1, 'алжирский динар', 'алжирских динара', 'алжирских динаров'],
            [1, 'сантим', 'сантима', 'сантимов']
        ],
        'EEK' => [
        ...
        'EGP' => [
            [1, 'египетский фунт', 'египетских фунта', 'египетских фунтов'],
        ...
        'IDR' => [
            [2, 'индонезийская рупия', 'индонезийских рупии', 'индонезийских рупий'],
            [1, 'сен', 'сена', 'сенов']
        ],
        'ILS' => [
            [1, 'израильский шекель', 'израильских шекеля', 'израильских шекелей'],
            [2, 'агора', 'агоры', 'агор']
        ],
        'IRR' => [
        ...
        'LYD' => [
            [1, 'ливийский динар', 'ливийских динара', 'ливийских динаров'],
            [1, 'дирхам', 'дирхама', 'дирхамов']
        ],
        'MAD' => [
            [1, 'марокканский дирхам', 'марокканских дирхама', 'марокканских дирхамов'],
            [1, 'сантим', 'сантима', 'сантимов']
        ],
        'MDL' => [
        ...
        'MXN' => [
            [1, 'мексиканский песо', 'мексиканских песо', 'мексиканских песо'],
            [1, 'сентаво', 'сентаво', 'сентаво']
        ],
        'MRO' => [
            [2, 'мавританская угия', 'мавританских угии', 'мавританских угий'],
            [1, 'хум', 'хума', 'хумов']
        ],
        'MTL' => [
        ...
        'MYR' => [
            [1, 'малайзийский ринггит', 'малайзийских ринггита', 'малайзийских ринггитов'],
            [1, 'сен', 'сена', 'сенов']
        ],
        'NGN' => [
            [2, 'нигерийская найра', 'нигерийских найры', 'нигерийских найр'],
            [1, 'кобо', 'кобо', 'кобо']
        ],
        'NOK' => [
        ...
        'PHP' => [
            [0, 'филиппинское песо', 'филиппинских песо', 'филиппинских песо'],
            [1, 'сентаво', 'сентаво', 'сентаво']
        ],
        'PLN' => [
        ...
        'SAR' => [
            [1, 'саудовский риял', 'саудовских рияла', 'саудовских риялов'],
            [1, 'халал', 'халала', 'халалов']
        ],
        'SEK' => [
        ...
        'TND' => [
            [1, 'тунисский динар', 'тунисских динара', 'тунисских динаров'],
            [1, 'миллим', 'миллима', 'миллимов']
        ],
        'UAH' => [
        ...
        'XAF' => [
            [1, 'западноафриканский франк КФА', 'западноафриканских франка КФА', 'западноафриканских франков КФА'],
            [1, 'сантим', 'сантима', 'сантимов']
        ],
        'XOF' => [
            [1, 'центральноафриканский франк КФА', 'центральноафриканских франка КФА', 'центральноафриканских франков КФА'],
            [1, 'сантим', 'сантима', 'сантимов']
        ],
        'XPF' => [
            [1, 'французский тихоокеанский франк', 'французских тихоокеанских франка', 'французских тихоокеанских франков'],
            [1, 'сантим', 'сантима', 'сантимов']
        ],
        'YUM' => [
