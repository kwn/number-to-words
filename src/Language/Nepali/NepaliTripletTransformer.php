...
class NepaliTripletTransformer implements TripletTransformer
{
    private NepaliDictionary $dictionary;

    public function __construct(NepaliDictionary $dictionary)
    {
