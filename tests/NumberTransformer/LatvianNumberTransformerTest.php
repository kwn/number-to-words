...
class LatvianNumberTransformerTest extends NumberTransformerTest
{
    ...
    public function providerItConvertsNumbersToWords()
    {
        return [
            ...
            [100, 'simts'], // viens simts
            [101, 'simts viens'], // viens simts viens
            [111, 'simts vienpadsmit'], // viens simts vienpadsmit
            [120, 'simts divdesmit'], // viens simts divdesmit
            [121, 'simts divdesmit viens'], // viens simts divdesmit viens
            [900, 'deviņi simti'],
            [909, 'deviņi simti deviņi'],
            [919, 'deviņi simti deviņpadsmit'],
            [990, 'deviņi simti deviņdesmit'],
            [999, 'deviņi simti deviņdesmit deviņi'],
            [1000, 'tūkstotis'], // viens tūkstotis
            [2000, 'divi tūkstoši'],
            [4000, 'četri tūkstoši'],
            [5000, 'pieci tūkstoši'],
            ...
            [1174315110, 'miljards simts septiņdesmit četri miljoni trīs simti piecpadsmit tūkstoši simts desmit'], // viens miljards
            [1174315119, 'miljards simts septiņdesmit četri miljoni trīs simti piecpadsmit tūkstoši simts deviņpadsmit'], // viens miljards
