...
class LatvianCurrencyTransformerTest extends CurrencyTransformerTestCase
{
    ...
    public static function providerItConvertsMoneyAmountToWords(): array
    {
        return [
            ...
            [100, 'GBP', 'viens sterliņu mārciņa un nulle pensi'],
            [0, 'JPY', 'nulle Japānas jēnas un nulle seni'],
            [726, 'NOK', 'septiņi Norvēģijas kronas un divdesmit seši ēres'],
            [101, 'SAR', 'viens Saūda Arābijas riyāls un viens hallāls'],
            [999, 'ZAR', 'deviņi Dienvidāfrikas rendi un deviņdesmit deviņi centi'],
